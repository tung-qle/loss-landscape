...
import cifar10.models.mlp as mlp
...
def load_MLP(input_dim, hidden_dims, output_dim, batch_norm_enabled = False, bias_enabled = True, model_file = None, data_parallel = False):
    net = mlp.MLP(input_dim, hidden_dims, output_dim, batch_norm_enabled, bias_enabled)
    if data_parallel: # the model is saved in data paralle mode
        net = torch.nn.DataParallel(net)
